#
#  Be sure to run `pod spec lint IonicPluginKeyboard.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  provides functions to make interacting with the keyboard easier
                   DESC

  s.homepage     = "https://ionicframework.com/docs/native/keyboard/"
